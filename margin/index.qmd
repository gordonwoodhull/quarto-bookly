    ...
    bookly-typst:
      ensureTypstFileRegexMatches:
        - # matches array (first positional argument)
          ...
          # Bookly emits parts with #part()
          - '#part\("Part I: Getting Started"\)'
          - '#part\("Part II: Advanced Topics"\)'
          # Bookly uses appendix + appendix-state
          - '#show: appendix'
          ...
          # Bookly-specific import and show rules
          - '#import "@local/bookly:1\.1\.3"'
          - '#show: main-matter'
          # Margin references
      ...
      ensurePdfRegexMatches:
        - # Bookly uses en-dash (–) for captions
      ...
      ensurePdfTextPositions:
        - # Code listings should be left-aligned with body text, not centered
          - subject: { text: "Alignmark", granularity: "Div" }
            ...
            tolerance: 15
          # Bookly page numbers verified via pdftk extraction
          # Recto (odd) pages have right margin, verso (even) have left margin
          # Chapter 1 margin figures
          ...
          # Chapter 1 margin equations
          - subject: "Gravitolex"
            relation: leftOf
            object: "Gravitonia"
            page: 10  # verso page - margin on left
          # Chapter 1 margin listings
          - subject: "Orbitsolva"
            relation: rightOf
            object: "Orbitcode"
            page: 11  # recto page - margin on right
          # Chapter 2 margin tables
          - subject: "Orbitperioda"
            relation: leftOf
            object: "Periodicus"
            page: 16  # verso page - margin on left
          # Chapter 2 margin subfigures
          - subject: "Waveluma"
            relation: rightOf
            object: "Chromatus"
          ...
          - subject: "Appendorba"
            relation: rightOf
            object: "Appendixia"
            page: 25  # recto page - margin on right
          # Appendix B margin content
          - subject: "Databvisual"
            relation: rightOf
            object: "Secondaria"
            page: 29  # recto page - margin on right
          ...
          - subject: "Gnomicon"
            relation: leftOf
            object: "Exegesis"
            page: 30  # verso page - margin on left
          ...
          - subject: "Diplodoca"
            relation: rightOf
            object: "Longneckia"
            page: 27  # recto page - margin on right
          - subject: "Parasaura"
            relation: leftOf
            object: "Hadrosaura"
            page: 30  # verso page - margin on left
